...
from .views import OrderUploadView, OrderListView, OrderDetailView, OrderStatusUpdateView, OrderCancelView, OCRImageUploadView

urlpatterns = [
    path('upload/', OrderUploadView.as_view(), name='order-upload'),
    path('upload/ocr/', OCRImageUploadView.as_view(), name='order-upload-ocr'),
