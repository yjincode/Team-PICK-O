# Generated by Django 4.2.7 on 2025-08-30 09:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('event', models.CharField(choices=[('anomaly_detected', '이상 탐지'), ('stock_low', '재고 부족'), ('price_fluctuation', '가격 변동'), ('system_error', '시스템 오류')], max_length=50, verbose_name='이벤트 유형')),
                ('severity', models.CharField(choices=[('LOW', '낮음'), ('MEDIUM', '보통'), ('HIGH', '높음'), ('CRITICAL', '긴급')], max_length=20, verbose_name='심각도')),
                ('title', models.CharField(max_length=200, verbose_name='알림 제목')),
                ('message', models.TextField(verbose_name='알림 내용')),
                ('link', models.CharField(blank=True, max_length=500, null=True, verbose_name='링크')),
                ('meta', models.JSONField(blank=True, default=dict, verbose_name='추가 데이터')),
                ...
                ('fish_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='fish_registry.fishtype', verbose_name='어종')),
                ('inventory_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory.inventory', verbose_name='재고')),
            ],
            options={
                'verbose_name': '알림',
                ...
                'db_table': 'alerts',
                'ordering': ['-detected_at'],
                'indexes': [models.Index(fields=['event', 'severity'], name='alerts_event_a88feb_idx'), models.Index(fields=['detected_at'], name='alerts_detecte_d53f05_idx'), models.Index(fields=['is_read', 'is_resolved'], name='alerts_is_read_9eb0b9_idx')],
            },
        ),
    ]
